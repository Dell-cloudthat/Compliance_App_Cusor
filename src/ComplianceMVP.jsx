...
const closeControlDetail = useCallback(() => {
  ...
  const ctx = {
    ...
    permissionLogs, setPermissionLogs,
    showPermissionGrant, setShowPermissionGrant,
    showVendorProfile, setShowVendorProfile,
    newPermission, setNewPermission,
    newVendorProfile, setNewVendorProfile,
    iamError, setIamError,
    selectedUser, setSelectedUser,
    userAccessDetails, setUserAccessDetails,
    ...
    frameworkGrowthData, setFrameworkGrowthData,
    ...
    alertRemediationLoading, setAlertRemediationLoading,
