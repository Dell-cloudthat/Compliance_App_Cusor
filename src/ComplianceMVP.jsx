...
const closeControlDetail = useCallback(() => {
  ...
  const ctx = {
    ...
    ALERT_ACTION_ICONS, CONNECTION_TYPES, FRAMEWORK_GLOSSARY, FRAMEWORK_LIBRARY, PRODUCT_LIBRARY, alertFirstDetectedTs, alertLastUpdatedTs, apiAttributedCount, coveragePercent, coveragePieStyle, coverageSegments, exportAutomationPlan, externalCoverageCount, fetchControlSegments, filteredControls, filtersAreDefault, formatRelative, frameworks, generateAutomationPlan, generateProjectTimeline, integrationMapSvgRef, loadDemoCSCAData, noApiControlsCount, ownershipPieStyle, ownershipSegments, priorityGuidance, selectedAlertRef, sharedControlsCount, sharedPercent, soloControlsCount, statusColors, totalControls, unassignedControlsCount,
    // Navigation
