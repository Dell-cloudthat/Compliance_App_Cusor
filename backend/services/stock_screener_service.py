...
class StockScreenerService:
    ...
    def _load_demo_stocks(self):
        ...
        demo_data = [
            ...
            # Note: eps_growth_forward_2y and revenue_growth_yoy use percentage points
            #       (e.g., 15 = 15% growth) to match user screen definition format
            # ============================================================================
            
            # Small-Cap Technology - Quality growth companies
            Stock("CWAN", "Clearwater Analytics", "USA", "NYSE", "Technology", "Software", 1850000000,
                  pe_ttm=28, pe_forward=22, debt_to_equity=0.10, interest_coverage=12, eps_growth_forward_2y=25,
                  roe=0.18, revenue_growth_yoy=22, profit_margin=0.15, current_ratio=3.2, quick_ratio=3.0,
                  rsi_14=35, average_volume_30d=850000, price_usd=18.50, sma_50=17.80, sma_200=16.50, beta=1.1),
            Stock("DOCN", "DigitalOcean Holdings", "USA", "NYSE", "Technology", "Cloud Infrastructure", 1650000000,
                  pe_ttm=22, pe_forward=18, debt_to_equity=0.35, interest_coverage=8, eps_growth_forward_2y=15,
                  roe=0.18, revenue_growth_yoy=12, profit_margin=0.10, current_ratio=2.5, quick_ratio=2.3,
                  rsi_14=32, average_volume_30d=1200000, price_usd=32.50, sma_50=31.00, sma_200=35.00, beta=1.4),
            Stock("INTA", "Intapp Inc", "USA", "NASDAQ", "Technology", "Enterprise Software", 1420000000,
                  pe_ttm=32, pe_forward=25, debt_to_equity=0.15, interest_coverage=10, eps_growth_forward_2y=28,
                  roe=0.15, revenue_growth_yoy=25, profit_margin=0.08, current_ratio=2.8, quick_ratio=2.6,
                  rsi_14=38, average_volume_30d=450000, price_usd=42.00, sma_50=40.50, sma_200=38.00, beta=1.2),
            Stock("PRGS", "Progress Software", "USA", "NASDAQ", "Technology", "Infrastructure Software", 1950000000,
                  pe_ttm=18, pe_forward=15, debt_to_equity=0.30, interest_coverage=12, eps_growth_forward_2y=10,
                  roe=0.22, revenue_growth_yoy=8, profit_margin=0.18, current_ratio=2.2, quick_ratio=2.0,
                  rsi_14=36, average_volume_30d=380000, price_usd=58.00, sma_50=56.00, sma_200=52.00, beta=0.9),
            Stock("RMBS", "Rambus Inc", "USA", "NASDAQ", "Technology", "Semiconductors", 1780000000,
                  pe_ttm=25, pe_forward=20, debt_to_equity=0.12, interest_coverage=18, eps_growth_forward_2y=18,
                  roe=0.20, revenue_growth_yoy=15, profit_margin=0.25, current_ratio=3.5, quick_ratio=3.2,
                  rsi_14=34, average_volume_30d=920000, price_usd=52.00, sma_50=50.00, sma_200=45.00, beta=1.3),
            Stock("RIOT", "Riot Platforms", "USA", "NASDAQ", "Technology", "Crypto", 1500000000,
                  pe_ttm=None, pe_forward=None, debt_to_equity=0.05, interest_coverage=None, eps_growth_forward_2y=50,
                  roe=-0.10, revenue_growth_yoy=80, profit_margin=-0.30, current_ratio=5.0, quick_ratio=4.8,
                  rsi_14=25, average_volume_30d=15000000, price_usd=8.50, sma_50=7.50, sma_200=10.00, beta=3.0),
            Stock("CVLT", "Commvault Systems", "USA", "NASDAQ", "Technology", "Data Management", 1480000000,
                  pe_ttm=28, pe_forward=22, debt_to_equity=0.10, interest_coverage=18, eps_growth_forward_2y=15,
                  roe=0.18, revenue_growth_yoy=12, profit_margin=0.10, current_ratio=2.8, quick_ratio=2.5,
                  rsi_14=37, average_volume_30d=350000, price_usd=145.00, sma_50=140.00, sma_200=130.00, beta=1.0),
            Stock("ANET2", "Arista Networks Small", "USA", "NYSE", "Technology", "Networking Equipment", 1450000000,
                  pe_ttm=22, pe_forward=18, debt_to_equity=0.05, interest_coverage=30, eps_growth_forward_2y=18,
                  roe=0.25, revenue_growth_yoy=15, profit_margin=0.20, current_ratio=4.0, quick_ratio=3.5,
                  rsi_14=36, average_volume_30d=680000, price_usd=48.00, sma_50=46.00, sma_200=42.00, beta=1.2),
            
            # Small-Cap Healthcare - Excluding Biotechnology
            Stock("PRVA", "Privia Health Group", "USA", "NASDAQ", "Healthcare", "Healthcare Services", 1680000000,
                  pe_ttm=32, pe_forward=25, debt_to_equity=0.08, interest_coverage=15, eps_growth_forward_2y=22,
                  roe=0.15, revenue_growth_yoy=18, profit_margin=0.04, current_ratio=2.0, quick_ratio=1.8,
                  rsi_14=33, average_volume_30d=720000, price_usd=16.80, sma_50=16.00, sma_200=18.00, beta=1.0),
            Stock("TMDX", "TransMedics Group", "USA", "NASDAQ", "Healthcare", "Medical Devices", 1890000000,
                  pe_ttm=28, pe_forward=22, debt_to_equity=0.15, interest_coverage=12, eps_growth_forward_2y=35,
                  roe=0.18, revenue_growth_yoy=45, profit_margin=0.12, current_ratio=3.5, quick_ratio=3.2,
                  rsi_14=38, average_volume_30d=680000, price_usd=68.00, sma_50=65.00, sma_200=55.00, beta=1.4),
            Stock("LNTH", "Lantheus Holdings", "USA", "NASDAQ", "Healthcare", "Diagnostics", 1920000000,
                  pe_ttm=12, pe_forward=10, debt_to_equity=0.18, interest_coverage=15, eps_growth_forward_2y=15,
                  roe=0.35, revenue_growth_yoy=12, profit_margin=0.25, current_ratio=3.2, quick_ratio=2.8,
                  rsi_14=33, average_volume_30d=1200000, price_usd=72.00, sma_50=70.00, sma_200=85.00, beta=1.1),
            Stock("RXST", "RxSight Inc", "USA", "NASDAQ", "Healthcare", "Medical Devices", 1350000000,
                  pe_ttm=30, pe_forward=24, debt_to_equity=0.05, interest_coverage=15, eps_growth_forward_2y=45,
                  roe=0.15, revenue_growth_yoy=55, profit_margin=0.08, current_ratio=8.0, quick_ratio=7.5,
                  rsi_14=30, average_volume_30d=550000, price_usd=42.00, sma_50=40.00, sma_200=38.00, beta=1.2),
            # Biotechnology stocks - should be excluded
            Stock("NRIX", "Nurix Therapeutics", "USA", "NASDAQ", "Healthcare", "Biotechnology", 850000000,
                  pe_ttm=None, pe_forward=None, debt_to_equity=0.02, interest_coverage=None, eps_growth_forward_2y=None,
                  roe=-0.35, revenue_growth_yoy=150, profit_margin=-2.50, current_ratio=12.0, quick_ratio=11.5,
                  rsi_14=22, average_volume_30d=450000, price_usd=18.50, sma_50=16.00, sma_200=22.00, beta=1.8),
            Stock("ADMA", "ADMA Biologics", "USA", "NASDAQ", "Healthcare", "Biotechnology", 1650000000,
                  pe_ttm=None, pe_forward=25, debt_to_equity=0.30, interest_coverage=5, eps_growth_forward_2y=40,
                  roe=0.08, revenue_growth_yoy=35, profit_margin=0.05, current_ratio=2.5, quick_ratio=1.8,
                  rsi_14=38, average_volume_30d=2800000, price_usd=18.00, sma_50=17.00, sma_200=12.00, beta=1.5),
            
            # Small-Cap Industrials
            Stock("POWL", "Powell Industries", "USA", "NASDAQ", "Industrials", "Electrical Equipment", 1650000000,
                  pe_ttm=15, pe_forward=12, debt_to_equity=0.05, interest_coverage=25, eps_growth_forward_2y=20,
                  roe=0.28, revenue_growth_yoy=35, profit_margin=0.12, current_ratio=2.8, quick_ratio=2.0,
                  rsi_14=38, average_volume_30d=320000, price_usd=145.00, sma_50=140.00, sma_200=120.00, beta=1.1),
            Stock("KTOS", "Kratos Defense", "USA", "NASDAQ", "Industrials", "Aerospace & Defense", 1480000000,
                  pe_ttm=32, pe_forward=26, debt_to_equity=0.25, interest_coverage=6, eps_growth_forward_2y=30,
                  roe=0.14, revenue_growth_yoy=15, profit_margin=0.06, current_ratio=2.5, quick_ratio=2.0,
                  rsi_14=35, average_volume_30d=1100000, price_usd=22.50, sma_50=21.50, sma_200=20.00, beta=1.3),
            Stock("MTUS", "Metallus Inc", "USA", "NYSE", "Industrials", "Steel", 720000000,
                  pe_ttm=8, pe_forward=7, debt_to_equity=0.35, interest_coverage=8, eps_growth_forward_2y=12,
                  roe=0.25, revenue_growth_yoy=8, profit_margin=0.08, current_ratio=2.0, quick_ratio=1.2,
                  rsi_14=28, average_volume_30d=380000, price_usd=16.00, sma_50=15.00, sma_200=18.00, beta=1.5),
            Stock("APOG", "Apogee Enterprises", "USA", "NASDAQ", "Industrials", "Building Products", 1380000000,
                  pe_ttm=12, pe_forward=10, debt_to_equity=0.20, interest_coverage=15, eps_growth_forward_2y=8,
                  roe=0.22, revenue_growth_yoy=6, profit_margin=0.08, current_ratio=2.2, quick_ratio=1.5,
                  rsi_14=32, average_volume_30d=350000, price_usd=62.00, sma_50=60.00, sma_200=58.00, beta=1.0),
            Stock("ROAD", "Construction Partners", "USA", "NASDAQ", "Industrials", "Construction", 1920000000,
                  pe_ttm=28, pe_forward=22, debt_to_equity=0.30, interest_coverage=10, eps_growth_forward_2y=18,
                  roe=0.15, revenue_growth_yoy=20, profit_margin=0.06, current_ratio=1.8, quick_ratio=1.5,
                  rsi_14=36, average_volume_30d=420000, price_usd=58.00, sma_50=55.00, sma_200=48.00, beta=1.2),
            Stock("UFPI", "UFP Industries", "USA", "NASDAQ", "Industrials", "Building Products", 1920000000,
                  pe_ttm=10, pe_forward=9, debt_to_equity=0.15, interest_coverage=20, eps_growth_forward_2y=8,
                  roe=0.22, revenue_growth_yoy=6, profit_margin=0.08, current_ratio=3.0, quick_ratio=1.8,
                  rsi_14=35, average_volume_30d=380000, price_usd=115.00, sma_50=112.00, sma_200=108.00, beta=1.0),
            Stock("SITE", "SiteOne Landscape", "USA", "NYSE", "Industrials", "Distributors", 1680000000,
                  pe_ttm=22, pe_forward=18, debt_to_equity=0.25, interest_coverage=10, eps_growth_forward_2y=12,
                  roe=0.18, revenue_growth_yoy=8, profit_margin=0.06, current_ratio=2.0, quick_ratio=1.2,
                  rsi_14=30, average_volume_30d=520000, price_usd=135.00, sma_50=130.00, sma_200=140.00, beta=1.2),
            
            # Small-Cap Consumer
            Stock("VITL", "Vital Farms Inc", "USA", "NASDAQ", "Consumer Staples", "Food Products", 1250000000,
                  pe_ttm=30, pe_forward=24, debt_to_equity=0.05, interest_coverage=20, eps_growth_forward_2y=22,
                  roe=0.18, revenue_growth_yoy=28, profit_margin=0.08, current_ratio=3.5, quick_ratio=2.8,
                  rsi_14=34, average_volume_30d=580000, price_usd=28.50, sma_50=27.00, sma_200=25.00, beta=0.9),
            Stock("SHOO", "Steven Madden Ltd", "USA", "NASDAQ", "Consumer Discretionary", "Footwear", 1850000000,
                  pe_ttm=14, pe_forward=12, debt_to_equity=0.10, interest_coverage=25, eps_growth_forward_2y=10,
                  roe=0.22, revenue_growth_yoy=8, profit_margin=0.10, current_ratio=3.0, quick_ratio=2.0,
                  rsi_14=36, average_volume_30d=650000, price_usd=42.00, sma_50=40.50, sma_200=38.00, beta=1.1),
            Stock("BROS", "Dutch Bros Inc", "USA", "NYSE", "Consumer Discretionary", "Restaurants", 1750000000,
                  pe_ttm=None, pe_forward=45, debt_to_equity=0.38, interest_coverage=5, eps_growth_forward_2y=35,
                  roe=0.08, revenue_growth_yoy=30, profit_margin=0.03, current_ratio=1.5, quick_ratio=1.2,
                  rsi_14=32, average_volume_30d=2200000, price_usd=32.00, sma_50=30.00, sma_200=28.00, beta=1.4),
            Stock("CALM", "Cal-Maine Foods", "USA", "NASDAQ", "Consumer Staples", "Food Products", 1850000000,
                  pe_ttm=5, pe_forward=8, debt_to_equity=0.02, interest_coverage=50, eps_growth_forward_2y=8,
                  roe=0.35, revenue_growth_yoy=25, profit_margin=0.18, current_ratio=4.5, quick_ratio=3.5,
                  rsi_14=32, average_volume_30d=450000, price_usd=38.00, sma_50=36.00, sma_200=42.00, beta=0.6),
            Stock("LESL", "Leslie's Inc", "USA", "NASDAQ", "Consumer Discretionary", "Specialty Retail", 680000000,
                  pe_ttm=12, pe_forward=10, debt_to_equity=0.35, interest_coverage=6, eps_growth_forward_2y=8,
                  roe=0.15, revenue_growth_yoy=6, profit_margin=0.06, current_ratio=1.8, quick_ratio=0.8,
                  rsi_14=25, average_volume_30d=1800000, price_usd=6.80, sma_50=6.50, sma_200=8.00, beta=1.6),
            
            # Small-Cap Financials
            Stock("COOP", "Mr. Cooper Group", "USA", "NASDAQ", "Financials", "Mortgage Finance", 1980000000,
                  pe_ttm=6, pe_forward=5, debt_to_equity=0.38, interest_coverage=8, eps_growth_forward_2y=12,
                  roe=0.28, revenue_growth_yoy=15, profit_margin=0.15, current_ratio=1.2, quick_ratio=1.0,
                  rsi_14=38, average_volume_30d=850000, price_usd=85.00, sma_50=82.00, sma_200=75.00, beta=1.2),
            Stock("OPFI", "OppFi Inc", "USA", "NYSE", "Financials", "Consumer Finance", 480000000,
                  pe_ttm=8, pe_forward=6, debt_to_equity=0.25, interest_coverage=10, eps_growth_forward_2y=15,
                  roe=0.35, revenue_growth_yoy=12, profit_margin=0.12, current_ratio=1.5, quick_ratio=1.3,
                  rsi_14=30, average_volume_30d=420000, price_usd=5.50, sma_50=5.20, sma_200=4.80, beta=1.4),
            Stock("STNE", "StoneCo Ltd", "USA", "NASDAQ", "Financials", "Fintech", 1650000000,
                  pe_ttm=12, pe_forward=9, debt_to_equity=0.15, interest_coverage=12, eps_growth_forward_2y=25,
                  roe=0.18, revenue_growth_yoy=20, profit_margin=0.10, current_ratio=2.0, quick_ratio=1.8,
                  rsi_14=28, average_volume_30d=3500000, price_usd=12.50, sma_50=11.80, sma_200=13.50, beta=1.6),
            Stock("PAYO", "Payoneer Global", "USA", "NASDAQ", "Financials", "Payment Processing", 1720000000,
                  pe_ttm=18, pe_forward=14, debt_to_equity=0.08, interest_coverage=15, eps_growth_forward_2y=20,
                  roe=0.15, revenue_growth_yoy=18, profit_margin=0.08, current_ratio=2.5, quick_ratio=2.3,
                  rsi_14=35, average_volume_30d=1800000, price_usd=8.20, sma_50=8.00, sma_200=8.50, beta=1.3),
            
            # Small-Cap Energy
            Stock("AROC", "Archrock Inc", "USA", "NYSE", "Energy", "Oil & Gas Equipment", 1580000000,
                  pe_ttm=15, pe_forward=12, debt_to_equity=0.35, interest_coverage=6, eps_growth_forward_2y=12,
                  roe=0.15, revenue_growth_yoy=10, profit_margin=0.12, current_ratio=1.5, quick_ratio=1.2,
                  rsi_14=38, average_volume_30d=980000, price_usd=22.00, sma_50=21.00, sma_200=18.50, beta=1.1),
            
            # Cannabis (should be excluded by sector)
            Stock("IIPR", "Innovative Industrial Props", "USA", "NYSE", "Cannabis", "Cannabis REITs", 1850000000,
                  pe_ttm=12, pe_forward=10, debt_to_equity=0.15, interest_coverage=8, eps_growth_forward_2y=8,
                  roe=0.14, revenue_growth_yoy=6, profit_margin=0.55, current_ratio=3.0, quick_ratio=2.8,
                  rsi_14=28, average_volume_30d=450000, price_usd=68.00, sma_50=65.00, sma_200=75.00, beta=1.2),
        ]
